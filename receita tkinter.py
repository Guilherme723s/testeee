...
tk.Label(root, text="Nome Da receita:", font=("Arial", 12)).grid(row=0, column=0, padx=10, pady=5, sticky="e")
entrada_nome = tk.Entry(root, width=20)
entrada_nome.grid(row=0, column=1, padx=10, pady=5)

tk.Label(root, text="Ingredientes:", font=("Arial", 12)).grid(row=1, column=0, padx=10, pady=5, sticky="e")
entrada_ingredientes = tk.Entry(root, width=20)
entrada_ingredientes.grid(row=1, column=1, padx=10, pady=5, sticky='w')

tk.Label(root, text="Modo de preparo:", font=("Arial", 12)).grid(row=2, column=0, padx=10, pady=5, sticky="e")
entrada_md = tk.Entry(root, width=20)
entrada_md.grid(row=2, column=1, padx=10, pady=5, sticky="e")

tk.Label (root, text="quanto tempo:",font=("Arial")).grid(row=3,column=0,padx=10,pady=5,sticky="e")
entrada_qt=tk.Entry(root,width=20)
entrada_qt.grid(row=3,column=1,padx=10,pady=5,sticky="e")

tk.Label (root, text="Rendimento:",font=("Arial")).grid(row=4,column=0,padx=10,pady=5,sticky="e")
entrada_qt=tk.Entry(root,width=20)
entrada_qt.grid(row=4,column=1,padx=10,pady=5,sticky="e")
...
def exibir_dados():
    ...
    gg = entrada_qt.get()
    label_resultado.config(text=f"Nome: {nome}, Ingredientes: {ingredientes}, Modo de preparo: {modo_preparo}, quanto tempo:{gg}")
